...
class ExtractItemTextFieldWidget<T> extends StatefulWidget {
  final String label;
  ...
  const ExtractItemTextFieldWidget({
    Key? key,
    this.value,
    this.label = '',
    this.onChangeField,
  ...
  @override
  State<ExtractItemTextFieldWidget<T>> createState() =>
      _IncomeTaxItemTextFieldState<T>();
}

class _IncomeTaxItemTextFieldState<T>
    extends State<ExtractItemTextFieldWidget<T>> {
