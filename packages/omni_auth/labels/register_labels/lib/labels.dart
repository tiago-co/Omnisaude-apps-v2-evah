class RegisterLabels {
  ...
  static const securityText = 'Não se preocupe! Seus dados estão seguros '
      'conosco e são necessários para confirmar sua '
      'identidade.';
  static const next = 'Próximo';
  static const save = 'Salvar';
  static const emptyFildError = 'Campo Obrigatório';

  static const verifyPersonalDataMainText = 'Sua identificação';

  static const verifyPersonalDataCPFLabel = 'CPF *';
  ...
  static const addressFormUFLabel = 'UF *';
  static const addressFormUFPlaceholder = 'UF';
  static const addressFormCityLabel = 'Cidade *';
  static const addressFormCityPlaceholder = 'Informe sua cidade';
  static const addressFormDistrictLabel = 'Bairro *';
  static const addressFormDistrictPlaceholder = 'Informe seu bairro';
  static const addressFormStreetLabel = 'Endereço *';
  static const addressFormStreetPlaceholder = 'Informe seu endereço';
  static const addressFormComplementLabel = 'Complemento';
  static const addressFormComplementPlaceholder = 'Informe um complemento';
  static const accessDataFormMainText = 'Dados de acesso';
  ...
  static const successPageMainText = 'Seu cadastro foi realizado!';
  static const successPageLoginButton = 'Realizar login';
}
