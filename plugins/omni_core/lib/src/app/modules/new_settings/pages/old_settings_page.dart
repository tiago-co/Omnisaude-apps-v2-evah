...
class OldSettingsPage extends StatefulWidget {
  final String? title;
  const OldSettingsPage({Key? key, this.title = 'Configurações'}) : super(key: key);
  @override
  OldSettingsPageState createState() => OldSettingsPageState();
}

class OldSettingsPageState extends State<OldSettingsPage> {
      ...
      body: Column(
        children: <Widget>[
          SettingsItemListWidget(
            ...
            trailing: TripleBuilder<UseBiometricsStore, Exception, UseBiometricPermission>(
