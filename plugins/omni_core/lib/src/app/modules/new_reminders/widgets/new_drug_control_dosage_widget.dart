...
class NewDrugControlDosageWidget extends StatefulWidget {
  ...
  @override
  _NewDrugControlDosageWidgetState createState() => _NewDrugControlDosageWidgetState();
}

class _NewDrugControlDosageWidgetState extends State<NewDrugControlDosageWidget> {
  ...
  Widget build(BuildContext context) {
    return TripleBuilder<NewDrugControlDosageStore, DioError, List<KeyValueModel>>(
      store: store,
      builder: (_, triple) {
        if (!widget.useCustomMedication) {
